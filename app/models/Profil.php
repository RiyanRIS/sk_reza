...
class Profil {
  ...
  public function getProfil()
	...
	{
		$query = "UPDATE `profil` SET `sistem`=:sistem,`lembaga`=:lembaga,`kabinet`=:kabinet,`kampus`=:kampus,`logo_lembaga`=:logo_lembaga,`logo_kampus`=:logo_kampus,`updated_at`=:updated_at WHERE `id`=:id";
		$this->db->query($query);
